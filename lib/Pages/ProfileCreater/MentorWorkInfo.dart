...
class MentorWorkInfo extends StatefulWidget {
  ...
  MentorWorkInfo(this.controller,this.slideIndex);
  @override
  _MentorWorkInfoState createState() => _MentorWorkInfoState();
}

class _MentorWorkInfoState extends State<MentorWorkInfo> {
  List<WorkListBean> work_list = new List<WorkListBean>();
  List<GlobalKey> _menuKey = new List<GlobalKey>();
